...
///     Example of correct usage of this class to maximise performance:
///     https://github.com/arthur100500/LadaEngine/tree/main/examples/MovingCamera
/// </summary>
public class SpriteGroup
{
    ...
    public void Render(Camera cam)
    {
        ...
        Renderer.Shader.SetFloat("zoom", cam.Zoom);
        Renderer.Render(cam);
    }
